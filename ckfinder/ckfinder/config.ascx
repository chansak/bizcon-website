...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        //LicenseName = "Nopphadol";
        //LicenseKey = "Soonthonsilsangworn";

		// The base URL used to reach files in CKFinder through the browser.
        //string userfiles = string.IsNullOrEmpty(Page.User.Identity.Name.ToString()) ? DateTime.Now.ToString("dd-MM-yyyy") : Page.User.Identity.Name.ToString();
        //string url = Request.RawUrl;
        //url = url.Substring(0, url.IndexOfAny("/".ToCharArray(), 1));
        BaseUrl = TextEditor.BaseUrl;//ConfigurationManager.AppSettings["AllFiles"] + "allFiles/" + userfiles + "/";    //"/ckfinder/userfiles/";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
        //if (Convert.ToBoolean(ConfigurationManager.AppSettings["IsDir"]))
        //    BaseDir = string.Format("{0}allFiles\\{1}\\", ConfigurationManager.AppSettings["PathDir"], userfiles);
        //else
        //    BaseDir = Server.MapPath(string.Format("{0}allFiles/{1}/", ConfigurationManager.AppSettings["AllFiles"], userfiles));
        BaseDir = TextEditor.BaseDir;
		// Thumbnail settings.
        ...
        Thumbnails.Dir = BaseDir == "" ? "" : BaseDir + "/_thumbs/";
