...
FCKConfig.ToolbarSets["Basic"] = [
	//['Bold','Italic','Underline','-','OrderedList','UnorderedList','-','Link','Unlink','-','TextColor','BGColor','FontSize']
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','-',
	'OrderedList','UnorderedList','-','Outdent','Indent','Blockquote'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink'],['Image','Smiley','SpecialChar','-','TextColor','BGColor','FontSize']	
] ;

FCKConfig.ToolbarSets["Default"] = [
    ['Source','DocProps','-','Preview','-','Templates'],['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
    '/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent','Blockquote'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
...
////////---------
FCKConfig.LinkBrowserURL = '../../../ckfinder/ckfinder.html?type=Files' ;
