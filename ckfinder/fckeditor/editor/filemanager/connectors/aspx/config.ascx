...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        //string path = KMP.URL.GetPage(Request.Url.ToString(),false);
        ...
        UserFilesPath = TextEditor.BaseUrl;// ConfigurationManager.AppSettings["AllFiles"] + "allFiles/" + userfiles;
        ...
        //    UserFilesAbsolutePath = string.Format("{0}allFiles\\{1}\\", ConfigurationManager.AppSettings["PathDir"], userfiles);
        //else
        //    UserFilesAbsolutePath = Server.MapPath(string.Format("{0}allFiles/{1}/", ConfigurationManager.AppSettings["AllFiles"], userfiles));
        UserFilesAbsolutePath = TextEditor.BaseDir;
