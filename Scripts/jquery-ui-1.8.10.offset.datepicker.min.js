...
1); s = this._daylightSavingAdjust(s)
      ...
      } J += e + (navigator.userAgent.match(/msie/i) && navigator.userAgent.match(/6/) && !a.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""); a._keyEvent = false; return J
